...
const Projects = () => {
  return (
    <section
      id="Projects"
      className="mt-12 mb-12 justify-center p-4 items-center lg:justify-center lg:items-center md:justify-center md:items-center sm:justify-center sm:items-center h-[100%] lg:w-full"
    >
