...
const About = () => {
  return (
    <section
      id="About"
      className="flex flex-col items-center z-[1000] mt-12 mb-12 p-2 h-auto lg:flex lg:justify-center lg:h-auto"
    >
      <p className="text-center text-lg text-slate-700 mt-12">Get To Know More</p>
      ...
      <div className="flex flex-col items-center gap-4 w-[90%] mt-12 mb-12 lg:flex lg:flex-row lg:justify-center">
        <div className="img flex justify-center w-[500px]">
          <img
            src={Pic1}
            alt="Profile"
            className="h-[250px] w-[250px] lg:h-[350px] lg:w-[350px] rounded-[45px]"
          />
        </div>
      ...
      <Link to="Experience" spy={true} smooth={true} offset={0} duration={600}>
